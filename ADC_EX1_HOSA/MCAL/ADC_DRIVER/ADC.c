...
void ADC_Init(void) {
	...
	// BITS 7-6: REFS 1:0, Reference Selection Bits, Choose 01 for AVCC
	// BIT 5: ADLAR 5, ADC Left Adjust Result, Set to 0 (Right Adjust)
	// BITS 4:0: MUX4:0, Analog Channels, Set to 00000 to choose ch 0
	ADMUX = ( 1 << REFS0);
	// I only set REFS0 to '1' because the rest are '0s' so I dont need to clear them.
